...
Semantic html adds meaning to all your html elements, by defining diferent sections of your html with tags that have semantic meanings like section article footer etc.
...
Git first allows teams storage for their code, it allows a team to track its source code manage changes and unlike other version controll software allows you to creat branches.

5. Define mobile-first design in your own words.
A mobile first design is desiging your web pages so they render on small screen sizes like 300px and look good from a user stand point.
